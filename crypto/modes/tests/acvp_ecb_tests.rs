...
fn run_case_for_key_len(
    ...
    match key_bytes.len() {
        16 => run_case::<AES128Internal, 16>(key_bytes, input, encrypt, grouping),
        24 => run_case::<AES192Internal, 24>(key_bytes, input, encrypt, grouping),
        32 => run_case::<AES256Internal, 32>(key_bytes, input, encrypt, grouping),
