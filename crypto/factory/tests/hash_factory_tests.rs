...
mod hash_factory_tests {
    ...
    use bouncycastle_core::traits::{Hash, HashFixedOutput, XOF};

    fn factory_hash(h: HashFactory, data: &[u8]) -> Vec<u8> {
        let mut out = vec![0u8; h.output_len()];
        h.hash_out(data, &mut out);
        out
    }
    ...
    mod sha3_tests {
        ...
        fn sha2_hash_tests() {
            ...
            assert_eq!(factory_hash(sha2, DUMMY_SEED_512), b"\xb8\x06\x0c\xcc\x82\xd4\x0c\x57\x61\x56\xf7\xca\x03\x33\xe4\x38\x9e\x41\x0d\xf0\x27\xd2\xfb\x8f\x76\x4f\xa6\x03");
            ...
            assert_eq!(factory_hash(sha2, DUMMY_SEED_512), b"\x11\x00\x09\xdc\xee\x21\x62\x0b\x16\x6f\x3a\xbf\xec\xb5\xef\xf7\xa8\x73\xbe\x72\x9d\x1c\x2d\x53\x82\x2e\x7a\xcc\x5f\x34\xeb\x9b");
            ...
            assert_eq!(factory_hash(sha2, DUMMY_SEED_512), b"\x45\x82\xfc\x82\x43\x0e\x52\x68\x86\xa1\x85\x34\x11\xe6\x06\x45\xfe\xf7\xe8\xea\x0c\x85\x46\xb7\xc9\xba\x0c\x84\x16\xd9\xa9\x8f\xb5\x2e\xbd\x0c\x60\x5f\xbb\x70\x74\x9c\x4e\x3e\x5d\xa3\xdb\xac");
            ...
            assert_eq!(factory_hash(sha2, DUMMY_SEED_512), b"");
        ...
        fn sha3_hash_tests() {
            ...
            assert_eq!(factory_hash(sha3, DUMMY_SEED_512), b"\xFE\x51\xC5\xD7\x62\x48\xE1\xE9\xD3\x01\x29\x6A\xE8\xAB\x94\x69\xD2\x86\x34\xB4\xAD\x3E\x9E\x78\xC8\xB0\x9D\x47");
            ...
            assert_eq!(factory_hash(sha3, DUMMY_SEED_512), b"\xD4\x72\x8E\xA5\xE9\xF3\x81\x9F\x2B\x47\x60\x15\x1A\x8F\x80\x2D\xBE\x9F\x94\x1F\xD6\xFB\x59\xB3\x71\x58\x92\x43\x65\x55\x77\x2A");
            ...
            assert_eq!(factory_hash(sha3, DUMMY_SEED_512), b"\xd5\x3b\x51\x68\x53\xf5\xac\xb4\xaa\xfd\xa5\x9d\x6f\x74\x0f\x69\x99\xc9\xe5\x21\x1c\x51\x03\x9c\x6d\x64\x5b\xf9\x83\xd7\xba\x0b\xdf\x12\x31\xb5\x50\x90\xb5\x5e\x35\x99\xee\x7a\xaa\x62\xd3\xbf");
            ...
            assert_eq!(factory_hash(sha3, DUMMY_SEED_512), b"");
        ...
        fn test_defaults() {
            ...
            let out = factory_hash(hash, DUMMY_SEED_512);
