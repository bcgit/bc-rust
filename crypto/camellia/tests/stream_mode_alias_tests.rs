//! Tests for the stream-mode aliases `Camellia_CFB_*`, `Camellia_CFB8_*` and `Camellia_CTR_*`.
//!
...
fn the_aliases_name_the_expected_types() {
    ...
    assert_eq!(
        size_of::<Camellia_CFB_128<Encrypting>>(),
        size_of::<Cfb<Camellia_128, Encrypting, 16, 16>>()
    );
    assert_eq!(
        size_of::<Camellia_CFB_192<Decrypting>>(),
        size_of::<Cfb<Camellia_192, Decrypting, 24, 16>>()
    );
    assert_eq!(
        size_of::<Camellia_CFB_256<Encrypting>>(),
        size_of::<Cfb<Camellia_256, Encrypting, 32, 16>>()
    );
    assert_eq!(
        size_of::<Camellia_CFB8_128<Encrypting>>(),
        size_of::<Cfb8<Camellia_128, Encrypting, 16, 16>>()
    );
    assert_eq!(
        size_of::<Camellia_CFB8_192<Decrypting>>(),
        size_of::<Cfb8<Camellia_192, Decrypting, 24, 16>>()
    );
    assert_eq!(
        size_of::<Camellia_CFB8_256<Encrypting>>(),
        size_of::<Cfb8<Camellia_256, Encrypting, 32, 16>>()
    );
    assert_eq!(
        size_of::<Camellia_CTR_128<Encrypting>>(),
        size_of::<Ctr<Camellia_128, Encrypting, 16, 16, 12>>()
    );
    assert_eq!(
        size_of::<Camellia_CTR_192<Decrypting>>(),
        size_of::<Ctr<Camellia_192, Decrypting, 24, 16, 12>>()
    );
    assert_eq!(
        size_of::<Camellia_CTR_256<Encrypting>>(),
        size_of::<Ctr<Camellia_256, Encrypting, 32, 16, 12>>()
    );
}

/// The const parameters are Camellia's, and CTR's nonce leaves the four-byte counter the mode caps
/// at.
#[test]
fn the_const_parameters_are_camellias() {
...
fn every_alias_round_trips_at_any_length() {
    ...
    check::<16, 16, Camellia_CFB_128<Encrypting>, Camellia_CFB_128<Decrypting>>("Camellia_CFB_128");
    check::<24, 16, Camellia_CFB_192<Encrypting>, Camellia_CFB_192<Decrypting>>("Camellia_CFB_192");
    check::<32, 16, Camellia_CFB_256<Encrypting>, Camellia_CFB_256<Decrypting>>("Camellia_CFB_256");
    check::<16, 16, Camellia_CFB8_128<Encrypting>, Camellia_CFB8_128<Decrypting>>(
        "Camellia_CFB8_128",
    );
    check::<24, 16, Camellia_CFB8_192<Encrypting>, Camellia_CFB8_192<Decrypting>>(
        "Camellia_CFB8_192",
    );
    check::<32, 16, Camellia_CFB8_256<Encrypting>, Camellia_CFB8_256<Decrypting>>(
        "Camellia_CFB8_256",
    );
    check::<16, 12, Camellia_CTR_128<Encrypting>, Camellia_CTR_128<Decrypting>>("Camellia_CTR_128");
    check::<24, 12, Camellia_CTR_192<Encrypting>, Camellia_CTR_192<Decrypting>>("Camellia_CTR_192");
    check::<32, 12, Camellia_CTR_256<Encrypting>, Camellia_CTR_256<Decrypting>>("Camellia_CTR_256");
}
...
fn cfb128_and_cfb8_are_not_interchangeable() {
    ...
    let (mut enc, got) = Camellia_CFB_128::<Encrypting>::do_encrypt_init_rng(
        &key::<16>(),
    ...
    let (mut enc8, got8) = Camellia_CFB8_128::<Encrypting>::do_encrypt_init_rng(
        &key::<16>(),
        &mut FixedSeedRNG::<BLOCK_LEN>::new(iv),
    )
    .expect("CFB8 init");
...
fn ctr_is_not_cfb() {
    ...
    let (_, nonce) = Camellia_CTR_128::<Encrypting>::encrypt(&key::<16>(), &mut as_ctr).unwrap();
    assert_eq!(nonce.len(), CTR_NONCE_LEN);

    let mut as_cfb = plaintext.clone();
    let (_, iv) = Camellia_CFB_128::<Encrypting>::encrypt(&key::<16>(), &mut as_cfb).unwrap();
    ...
    Camellia_CFB_128::<Decrypting>::decrypt(&key::<16>(), &iv_from_nonce, &mut misread)
