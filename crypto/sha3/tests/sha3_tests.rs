...
mod sha3_tests {
    ...
    use bouncycastle_core::traits::{Hash, HashAlgParams, HashFixedOutput, KDF, SecurityStrength};
    ...
    fn test_framework_hash() {
        ...
        test_framework.test_hash::<SHA3_224, 28>(DUMMY_SEED_512, b"\xFE\x51\xC5\xD7\x62\x48\xE1\xE9\xD3\x01\x29\x6A\xE8\xAB\x94\x69\xD2\x86\x34\xB4\xAD\x3E\x9E\x78\xC8\xB0\x9D\x47");
        test_framework.test_hash::<SHA3_256, 32>(DUMMY_SEED_512, b"\xD4\x72\x8E\xA5\xE9\xF3\x81\x9F\x2B\x47\x60\x15\x1A\x8F\x80\x2D\xBE\x9F\x94\x1F\xD6\xFB\x59\xB3\x71\x58\x92\x43\x65\x55\x77\x2A");
        test_framework.test_hash::<SHA3_384, 48>(DUMMY_SEED_512, b"\xd5\x3b\x51\x68\x53\xf5\xac\xb4\xaa\xfd\xa5\x9d\x6f\x74\x0f\x69\x99\xc9\xe5\x21\x1c\x51\x03\x9c\x6d\x64\x5b\xf9\x83\xd7\xba\x0b\xdf\x12\x31\xb5\x50\x90\xb5\x5e\x35\x99\xee\x7a\xaa\x62\xd3\xbf");
        test_framework.test_hash::<SHA3_512, 64>(DUMMY_SEED_512, b"");
    }
    ...
    fn run_test_case(tc: TestCase, mut sha3: impl Hash) {
        ...
        if partial_bits == 0 {
            ...
            bytes_written = sha3.do_final_out(&mut output);
        } else {
            sha3.do_update(&tc.msg[..(tc.msg.len() - 1)]);
            bytes_written = sha3
                .do_final_partial_bits_out(tc.msg[tc.msg.len() - 1], partial_bits, &mut output)
                .unwrap();
        }

        assert_eq!(tc.hash, &output[..bytes_written]);
    }
}
