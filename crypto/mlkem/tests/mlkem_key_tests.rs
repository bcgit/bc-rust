...
mod mlkem_key_tests {
    ...
    use bouncycastle_mlkem::{MLKEMPrivateKeyTrait, MLKEMPublicKeyTrait, MLKEMTrait};
    use bouncycastle_mlkem::{MLKEM512, MLKEM768, MLKEM1024};
    use bouncycastle_mlkem::{MLKEM512PrivateKey, MLKEM512PublicKey, MLKEM768PrivateKey, MLKEM768PublicKey, MLKEM1024PrivateKey, MLKEM1024PublicKey};
    use bouncycastle_mlkem::{MLKEM512_PK_LEN, MLKEM512_SK_LEN, MLKEM512_CT_LEN, MLKEM768_PK_LEN, MLKEM768_SK_LEN, MLKEM768_CT_LEN, MLKEM1024_PK_LEN, MLKEM1024_SK_LEN, MLKEM1024_CT_LEN, MLKEM_SS_LEN};
    ...
    fn seed() {
        ...
        let sk_bytes = sk.encode();
        let sk2 = MLKEM512PrivateKey::from_bytes(&sk_bytes).unwrap();
    ...
    fn test_display_expanded_key() {
        use bouncycastle_mlkem::{MLKEM512PublicKeyExpanded, MLKEM512PrivateKeyExpanded};
        use bouncycastle_mlkem::{MLKEM768PublicKeyExpanded, MLKEM768PrivateKeyExpanded};
        use bouncycastle_mlkem::{MLKEM1024PublicKeyExpanded, MLKEM1024PrivateKeyExpanded};
