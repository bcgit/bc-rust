...
mod mlkem_key_tests {
    ...
    use bouncycastle_mlkem::{
        MLKEM512_PK_LEN, MLKEM512_SK_LEN,
        MLKEM512PrivateKeyExpanded, MLKEM512PublicKeyExpanded, MLKEM768_PK_LEN,
        MLKEM768_SK_LEN, MLKEM1024_PK_LEN, MLKEM1024_SK_LEN,
        MLKEMPrivateKeyTrait, MLKEMPublicKeyTrait, MLKEMTrait,
    };
    ...
    fn core_framework_tests() {
        ...
        tf.test_keys::<MLKEM512PublicKey, MLKEM512PrivateKey, MLKEM512_PK_LEN, MLKEM512_SK_LEN>(MLKEM512::keygen);
        tf.test_keys::<MLKEM768PublicKey, MLKEM768PrivateKey, MLKEM768_PK_LEN, MLKEM768_SK_LEN>(MLKEM768::keygen);
