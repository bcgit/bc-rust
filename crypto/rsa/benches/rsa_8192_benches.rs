//! Criterion benches for RSA-8192. See `rsa_2048_benches.rs`'s docs for the rationale; the genuine
//! key is the same fresh, self-generated one `tests/rsa_8192_tests.rs` uses for its BC Java
...
use bouncycastle_rsa::rsa_8192::{
    ...
    pkcs1_v1_5_verify_sha512, pss_sign_sha256, pss_sign_sha384, pss_sign_sha512, pss_verify_sha256,
...
fn bench_rsa_8192(c: &mut Criterion) {
    ...
    let mut group = c.benchmark_group("rsa_8192");
...
criterion_group!(benches, bench_rsa_8192);
