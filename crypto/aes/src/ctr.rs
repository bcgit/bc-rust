...
pub type AES_CTR_128<Dir> = Ctr<AES128Internal, Dir, 16, BLOCK_LEN, CTR_NONCE_LEN>;
...
/// ```
#[allow(non_camel_case_types)]
pub type AES_CTR_192<Dir> = Ctr<AES192Internal, Dir, 24, BLOCK_LEN, CTR_NONCE_LEN>;
...
/// ```
#[allow(non_camel_case_types)]
pub type AES_CTR_256<Dir> = Ctr<AES256Internal, Dir, 32, BLOCK_LEN, CTR_NONCE_LEN>;
