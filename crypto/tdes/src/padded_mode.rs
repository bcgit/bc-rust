...
//!     Cbc<TDES, Encrypting, 24, 8>,   // what Encrypting resolves to
//!     Cbc<TDES, Decrypting, 24, 8>,   // what Decrypting resolves to
//!     Pad, 8,
//! >>::Mode;
//! ```
//!
//! One trait serves both block modes, since it is parameterised by the encryptor and decryptor
...
pub trait PaddedMode<Enc, Dec, Pad, const INIT_DATA_LEN: usize>
where
