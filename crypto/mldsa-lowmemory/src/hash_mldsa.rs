...
//! ```
//!
//! There is also access to the pre-hashed function available from [PHSignature]:
//!
//! ```rust
//! use bouncycastle_core::errors::SignatureError;
    ...
    >
{
    ...
    /// It can be set anywhere after [Signature::sign_init] and before [Signature::sign_final]
