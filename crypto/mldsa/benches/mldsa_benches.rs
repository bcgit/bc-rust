...
use bouncycastle_mldsa::{MLDSAPrivateKeyTrait, MLDSATrait, MLDSA44, MLDSA65, MLDSA87};
...
fn bench_mldsa_sign(c: &mut Criterion) {
    ...
    group.bench_function("ML-DSA-44", |b| {
        b.iter(|| {
            let mu = MLDSA44::compute_mu_from_sk(msg, None, &mldsa44_sk).unwrap();
    ...
    group.bench_function("ML-DSA-65", |b| {
        b.iter(|| {
            let mu = MLDSA65::compute_mu_from_sk(msg, None, &mldsa65_sk).unwrap();
    ...
    group.bench_function("ML-DSA-87", |b| {
        b.iter(|| {
            let mu = MLDSA87::compute_mu_from_sk(msg, None, &mldsa87_sk).unwrap();
...
fn bench_mldsa_sign_from_seed(c: &mut Criterion) {
    ...
    group.bench_function("ML-DSA-44", |b| {
        b.iter(|| {
            let mu = MLDSA44::compute_mu_from_tr(msg, None, &tr).unwrap();
    ...
    group.bench_function("ML-DSA-65", |b| {
        b.iter(|| {
            let mu = MLDSA65::compute_mu_from_tr(msg, None, &tr).unwrap();
    ...
    group.bench_function("ML-DSA-87", |b| {
        b.iter(|| {
            let mu = MLDSA87::compute_mu_from_tr(msg, None, &tr).unwrap();
...
criterion_group!(benches, bench_mldsa_keygen, bench_mldsa_sign, bench_mldsa_sign_from_seed, bench_mldsa_verify);
