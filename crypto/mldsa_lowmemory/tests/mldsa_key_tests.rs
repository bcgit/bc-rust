...
mod mldsa_key_tests {
    ...
    use bouncycastle_core::traits::{
        SecurityStrength, SignaturePrivateKey, SignaturePublicKey,
    };
    ...
    fn core_framework_tests() {
        ...
        tf.test_keys::<MLDSA44PublicKey, MLDSA44PrivateKey, MLDSA44_PK_LEN, MLDSA44_SK_LEN>(MLDSA44::keygen);
        tf.test_keys::<MLDSA65PublicKey, MLDSA65PrivateKey, MLDSA65_PK_LEN, MLDSA65_SK_LEN>(MLDSA65::keygen);
        tf.test_keys::<MLDSA87PublicKey, MLDSA87PrivateKey, MLDSA87_PK_LEN, MLDSA87_SK_LEN>(MLDSA87::keygen);
    }
