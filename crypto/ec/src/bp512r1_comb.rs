...
fn table_lookup(secret_index: usize) -> (Bp512r1FieldElement, Bp512r1FieldElement, Condition<u64>) {
    ...
    (
        Bp512r1FieldElement::from_limbs(x_limbs),
        Bp512r1FieldElement::from_limbs(y_limbs),
        is_infinity,
    )
}
