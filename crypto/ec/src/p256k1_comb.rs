...
fn table_lookup(secret_index: usize) -> (P256K1FieldElement, P256K1FieldElement, Condition<u64>) {
    ...
    (
        P256K1FieldElement::from_internal_limbs(x_limbs),
        P256K1FieldElement::from_internal_limbs(y_limbs),
        is_infinity,
    )
}
