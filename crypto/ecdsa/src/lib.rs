...
//! # Status
//!
//! P-256 (SHA-256), P-384 (SHA-384), P-521 (SHA-512), and secp256k1 (SHA-256). See
//! `local/ec_custom_curves_and_ecdsa_plan.md` §6 and §9 for the rest of the plan (brainpool curves,
//! SM2, CLI wiring, benches).
//!
