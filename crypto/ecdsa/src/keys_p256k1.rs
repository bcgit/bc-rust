...
/// Table 2 associates with secp256k1's 256-bit order (`f = 256-383` in that table's ECC column, giving
/// 128-bit security).
pub fn keygen_from_rng(
    ...
    // strength secp256k1's 256-bit order calls for (SP 800-57 Part 1 Rev. 5, Table 2: 128 bits).
