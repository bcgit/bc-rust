...
fn sign_with_k(
    ...
    let k_field = Bp384r1ScalarField::from_secret(&k);
    ...
    let d_field = Bp384r1ScalarField::from_secret(sk.scalar());
...
impl ECDSABp384r1 {
    ...
    pub fn sign_randomized(
        ...
        let mut extra_bits = [0u8; crate::keys_bp384r1::EXTRA_BITS_DRBG_OUTPUT_LEN];
