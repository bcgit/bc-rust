...
/// Table 2 associates with P-384's 384-bit order (`f = 384-511` in that table's ECC column, giving
/// 192-bit security).
pub fn keygen_from_rng(
    ...
    // strength P-384's 384-bit order calls for (SP 800-57 Part 1 Rev. 5, Table 2: 192 bits).
