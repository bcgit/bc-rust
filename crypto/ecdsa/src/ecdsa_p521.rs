...
use crate::keys_p521::{
    ECDSAP521PrivateKey, ECDSAP521PublicKey, PK_LEN, SK_LEN, reduce_wide_bits_mod_n_minus_1,
};
...
impl ECDSAP521 {
    ...
    /// deterministic default. See [`crate::ecdsa_p256::ECDSAP256::sign_randomized`]'s docs. Uses
    /// [`crate::keys_p521`]'s own copy of the wide-reduction machinery [`crate::extra_bits`]
    /// implements for P-256, needed here for a different reason -- see that module's docs.
